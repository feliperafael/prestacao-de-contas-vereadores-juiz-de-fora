...
plt.suptitle('CUSTEIO DA ATIVIDADE PARLAMENTAR - balanço '+year)
plt.title('Gastos com verba indenizatória da câmara municipal de Juiz de Fora - MG '+year)
total_gasto = locale.currency( round(sum(nome_valor['valor']), 2), grouping = True )
plt.text(0,14000, 'Gasto total com verba indenizatória no ano de '+year+': '+str(total_gasto))
